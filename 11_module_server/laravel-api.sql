...
INSERT INTO `consultations` (`id_consultations`, `society_id`, `doctor_id`, `status`, `disease_history`, `current_symptoms`, `doctor_notes`) VALUES
...
(44, 1, NULL, 'pending', NULL, 'we', NULL);
...
INSERT INTO `medicals` (`id_medical`, `spot_id`, `user_id`, `role`, `name_medicals`) VALUES
...
CREATE TABLE `societies` (
  ...
  `name_societies` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `societies` (`id_societies`, `id_card_number`, `password`, `name_societies`, `born_date`, `gender`, `address`, `regional_id`, `login_tokens`, `updated_at`) VALUES
(1, '20210001', '121212', 'Omar Gunawan', '1990-04-18', 'male', 'Jln. Baranang Siang No. 479, DKI Jakarta', 1, 'd9d09b1f57dcb100fe69c98c93f37de4', '2022-05-22'),
(2, '20210002', '121212', 'Nilam Sinaga', '1998-09-11', 'female', 'Gg. Sukajadi No. 26, DKI Jakarta', 1, NULL, NULL),
(3, '20210003', '121212', 'Rosman Lailasari', '1983-02-12', 'male', 'Jln. Moch. Ramdan No. 242, DKI Jakarta', 1, '0a11a7db942d022cb1f771a93f0e8cb5', '2022-05-22'),
(4, '20210004', '121212', 'Ifa Adriansyah', '1993-05-17', 'female', 'Gg. Setia Budi No. 215, DKI Jakarta', 1, NULL, NULL),
(5, '20210005', '121212', 'Sakura Susanti', '1973-11-05', 'male', 'Kpg. B.Agam 1 No. 729, DKI Jakarta', 1, NULL, NULL),
(6, '20210006', '121212', 'Jail Utama', '2001-12-28', 'male', 'Kpg. Cikutra Timur No. 57, DKI Jakarta', 1, NULL, NULL),
(7, '20210007', '121212', 'Gawati Wibowo', '1971-08-23', 'male', 'Kpg. Bara No. 346, DKI Jakarta', 1, NULL, NULL),
...
(20, '20210020', '121212', 'Hani Pratiwi', '1990-07-10', 'male', 'Dk. Yap Tjwan Bing No. 528, DKI Jakarta', 2, '8ca7a57698936819b0022a06625eab70', '2022-05-22'),
...
(36, '20210036', '121212', 'Damar Palastri', '1981-03-24', 'female', 'Jr. Teuku Umar No. 547, West Java', 3, '531f4e7812c5eb237b7b51bc8c74718d', '2022-05-22'),
(37, '20210037', '121212', 'Gamanto Simanjuntak', '1972-01-13', 'female', 'Jln. Salam No. 421, West Java', 3, NULL, NULL),
(38, '20210038', '121212', 'Lukita Gunarto', '1998-11-27', 'female', 'Jr. HOS. Cjokroaminoto (Pasirkaliki) No. 9, West Java', 3, '7a6f9adbda7ab13cd8524e2d28586874', '2022-05-21'),
...
(44, '20210044', '121212', 'Pangestu Lazuardi', '2001-08-02', 'male', 'Dk. Bass No. 886, West Java', 3, '9e1058f74225f3f5741ac300f9f304f8', '2022-05-22'),
...
CREATE TABLE `spots` (
  ...
  `regional_id_spot` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `spots` (`id_spots`, `regional_id_spot`, `name`, `address`, `serve`, `capacity`) VALUES
...
(37, 1, '2022-09-09', 1, 1, NULL, NULL, NULL),
(38, 1, '2022-01-09', 20, 2, NULL, NULL, NULL);
...
ALTER TABLE `spots`
  ...
  ADD KEY `spots_regional_id_foreign` (`regional_id_spot`);
...
--
ALTER TABLE `consultations`
  MODIFY `id_consultations` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `medicals`
--
ALTER TABLE `medicals`
  MODIFY `id_medical` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `societies`
  MODIFY `id_societies` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `spots`
--
ALTER TABLE `spots`
  MODIFY `id_spots` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `spot_vaccines`
--
ALTER TABLE `spot_vaccines`
  MODIFY `id_spot_vaccines` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `vaccinations`
  MODIFY `id_vaccinations` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `consultations`
  ADD CONSTRAINT `consultations_doctor_id_foreign` FOREIGN KEY (`doctor_id`) REFERENCES `medicals` (`id_medical`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `consultations_society_id_foreign` FOREIGN KEY (`society_id`) REFERENCES `societies` (`id_societies`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `medicals`
--
ALTER TABLE `medicals`
  ADD CONSTRAINT `medicals_spot_id_foreign` FOREIGN KEY (`spot_id`) REFERENCES `spots` (`id_spots`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `societies`
  ADD CONSTRAINT `societies_regional_id_foreign` FOREIGN KEY (`regional_id`) REFERENCES `regionals` (`id_regionals`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `spots`
--
ALTER TABLE `spots`
  ADD CONSTRAINT `spots_regional_id_foreign` FOREIGN KEY (`regional_id_spot`) REFERENCES `regionals` (`id_regionals`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `spot_vaccines`
--
ALTER TABLE `spot_vaccines`
  ADD CONSTRAINT `spot_vaccines_spot_id_foreign` FOREIGN KEY (`spot_id`) REFERENCES `spots` (`id_spots`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `spot_vaccines_vaccine_id_foreign` FOREIGN KEY (`vaccine_id`) REFERENCES `vaccines` (`id_vaccines`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `vaccinations`
--
ALTER TABLE `vaccinations`
  ADD CONSTRAINT `vaccinations_doctor_id_foreign` FOREIGN KEY (`doctor_id`) REFERENCES `medicals` (`id_medical`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `vaccinations_officer_id_foreign` FOREIGN KEY (`officer_id`) REFERENCES `medicals` (`id_medical`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `vaccinations_society_id_foreign` FOREIGN KEY (`society_id`) REFERENCES `societies` (`id_societies`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `vaccinations_spot_id_foreign` FOREIGN KEY (`spot_id`) REFERENCES `spots` (`id_spots`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `vaccinations_vaccine_id_foreign` FOREIGN KEY (`vaccine_id`) REFERENCES `vaccines` (`id_vaccines`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
